            ...
            <div class="col-lg-3 col-md-6 col-sm-12 p-6">
                ...
                <div class="myCard h-100">
                    ...
                    <div class="coverImage dishCover">
                        <img src="{{ !empty($dish->image) ? asset('storage/' . $dish->image) : asset('storage/uploads/placeholder.png') }}" alt="{{ $dish->name }}" class="w-100">
                    ...
                    <div class="d-flex flex-column justify-content-between flex-grow-1">
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <button type="button" class="deletebutton" data-bs-toggle="modal" data-bs-target="#dish-{{ $dish->id }}">
                                <span>CANCELLA</span>
